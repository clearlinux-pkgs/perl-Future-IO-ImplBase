...
Version  : 0.07
Release  : 6
URL      : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Future-IO-0.07.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Future-IO-0.07.tar.gz
...
%prep
%setup -q -n Future-IO-0.07
cd %{_builddir}/Future-IO-0.07
...
cp %{_builddir}/Future-IO-0.07/LICENSE %{buildroot}/usr/share/package-licenses/perl-Future-IO-ImplBase/7e88e362b09da4b18d7e611c14945b5734383496
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/Future/IO.pm
/usr/lib/perl5/vendor_perl/5.30.3/Future/IO/ImplBase.pm
