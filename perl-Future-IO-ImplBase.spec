...
Version  : 0.16
Release  : 26
URL      : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Future-IO-0.16.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Future-IO-0.16.tar.gz
...
%prep
%setup -q -n Future-IO-0.16
cd %{_builddir}/Future-IO-0.16
...
cp %{_builddir}/Future-IO-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Future-IO-ImplBase/ff3cb0dfd45f53bab83fc8e6480335b7afdc4bbe || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Future-IO-ImplBase/ff3cb0dfd45f53bab83fc8e6480335b7afdc4bbe
