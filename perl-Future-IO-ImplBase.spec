...
Version  : 0.11
Release  : 15
URL      : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Future-IO-0.11.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Future-IO-0.11.tar.gz
...
%prep
%setup -q -n Future-IO-0.11
cd %{_builddir}/Future-IO-0.11
...
cp %{_builddir}/Future-IO-0.11/LICENSE %{buildroot}/usr/share/package-licenses/perl-Future-IO-ImplBase/0f1bd461e6c8275b65b9150dd225781413cf39b6
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Future-IO-ImplBase/0f1bd461e6c8275b65b9150dd225781413cf39b6
